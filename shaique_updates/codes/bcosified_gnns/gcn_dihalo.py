...
def main():
    ...
    seeds = [0, 1, 2]
    experiments = ["vanilla_gcn_sum", "bcos_gcn_sum"]
    ...
    seed_results_csv = RESULTS_DIR / "gcn_dihalo_all_seed_results.csv"
    summary_csv = RESULTS_DIR / "gcn_dihalo_summary_mean_std.csv"
    combined_csv = RESULTS_DIR / "gcn_dihalo_all_results_with_summary.csv"
